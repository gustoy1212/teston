--[[
    script v3 - agora com sistema de fuga paranoico
    arrumei a parte q ele ficava parado moscando qnd tava com pouca vida
    agora ele checa se tem qlqr bixo perto antes de parar
]]
...
local CONFIG = {
    ...
    VidaBaixa = 25,  
    VidaCheia = 90, 
    DistSeguranca = 50, -- distancia minima pra ele se sentir seguro e parar pra curar
        ...
        if Estado.Rodando then
            ...
            if Estado.Fugindo then
                if vidaAtual >= CONFIG.VidaCheia then
                    ...
                    -- ESCANEIA O PERIGO MAIS PROXIMO (mesmo se nao tiver alvo)
                    ...
                    -- Se tiver qlqr bixo perto (menos de 50 studs), CORRE
                    if perigoMaisPerto and distPerigo < CONFIG.DistSeguranca then
                        ...
                        -- Se ta longe de tudo, ai sim pode parar
                ...
                if Estado.AlvoAtual then
                    ...
                    LabelStatus.Text = "procurando vitima..."
                    local pastaMobs = Workspace:FindFirstChild("Mobs")
                    ...
                    if pastaMobs then
                        ...
                        if melhorAlvo then 
                            ...
                            ControlaSprint(false) 
                            Parar() 
                            LabelStatus.Text = "ninguem perto..."
                        end
                    end
                end
            end
