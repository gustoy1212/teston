--[[
    🧙‍♂️ RPG MAGNET GOD v40 (DUAL MODE)
    
    DOIS MODOS DE FARM:
    1. SINGLE (1v1): Traz um inimigo por vez. Seguro e leve.
    2. BLACK HOLE (Mass): Traz TODOS os inimigos do mapa para sua frente.
       - Ideal para usar Skills em área (AOE).
    
    SEGURANÇA:
    - No Collision: Todos os inimigos ficam "fantasmas" para não te travar.
    - Restore: Ao desligar, os inimigos voltam ao normal.
]]
