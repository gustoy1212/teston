--[[
    🧟 HUNTER ZOMBIE - THE CLUSTER BOMB (v21.1 FIXED)
    
    CORREÇÃO DE POSICIONAMENTO:
    - HoverHeight reduzido para 15 (Fica dentro da hitbox, não acima dela).
    - HitboxSize aumentado para 70 (Garante o hit).
]]
...
local SETTINGS = {
    ...
    HoverHeight = 15,     -- BAIXEI AQUI (Era 35, agora é 15 pra ficar "dentro")
    HitboxSize = 70,      -- AUMENTEI AQUI (Era 60)
...
ScreenGui.Name = "ZombieClusterFix"
...
MainFrame.BackgroundColor3 = Color3.fromRGB(30, 0, 0) -- Vermelho Escuro
...
ToggleBtn.Text = "LIGAR FARM (FIXED HEIGHT)"
...
ToggleBtn.MouseButton1Click:Connect(function()
    ...
    if isRunning then
        ...
        ToggleBtn.Text = "LIGAR FARM (FIXED)"
        ToggleBtn.BackgroundColor3 = Color3.fromRGB(60, 20, 20)
        Status.Text = "Parado"
        DisableFlight()
        UpdateCluster(nil) 
...
RunService.Heartbeat:Connect(function()
    ...
    if LockedTarget then
        ...
        -- POSICIONAMENTO CORRIGIDO (HoverHeight = 15)
